...
const DEF={users:[{id:"boss",name:"Boss KC",role:"boss",pin:"0000",dept:null,canManage:true,canViewAll:true,canScore:true,avatar:null}],employees:[],vehicles:[],logoUrl:null,bonusConfig:null,feedbacks:[],attendance:{}};
